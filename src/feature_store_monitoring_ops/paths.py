...
DEFAULT_RELEASE_VERIFICATION_REPORT_PATH = (
    PROJECT_ROOT / "reports" / "portfolio" / "verification_0.1.0.md"
)
DEFAULT_RELEASE_GATE_REPORT_PATH = PROJECT_ROOT / "reports" / "portfolio" / "release_gate_0.1.0.md"
DEFAULT_RELEASE_GATE_METRICS_PATH = (
    PROJECT_ROOT / "reports" / "portfolio" / "release_gate_0.1.0.json"
)
